...
<template>
  <div class="list">
    ...
    <div class="paragraph">
      ...
      significant materials that would be helpful for the research on this topic. This part will be
      divided into two sections. The first are archives that contain rich, valuable, and massive
      primary sources, which will be very important and useful for research. The second part will be
      articles, especially scholarly research articles, on this topic. The perspectives of different
      scholars will give us a new and different opinion, which may give us new inspiration.
    </div>
    ...
    <div class="paragraph">
      ...
      America) including data of a political, economic, social, cultural, and religious nature. Such
      an archive provides materials covering widely the topic and can be helpful to research.
    </div>
    ...
    <div class="paragraph">
      ...
      Powers Movement. The core opinion is that it was the Black Powers Movement instead of the
      Civil Rights Movement that led to this transition and promoted black identity and cohesion and
    ...
    <div class="paragraph">
      ...
      “Negro question” is intimately imbricated with questions of Being. Antiblackness had become an
      essential part in white supremacy, and it gave white supremacists the precondition to ground
      and affirm themselves. Dr. Watson cites this paper to support his argument that white
      supremacists need to derogate and oppose black people for their self-proud whiteness
      identities is a part of the foundation ideas of white supremacy, and that is why black people
      must and almost destroy it. It is the same today for other minority groups, especially Asian
      Americans. White supremacists were not only towards black people but also any ethnic groups
      but white people themselves. The racism from white supremacists against minority groups can be
    ...
    <div class="paragraph">
      ...
      American society must dismantle the pillars of the perpetual foreigner stereotype by
